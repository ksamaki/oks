...
public class OksLogRateLimitConfiguration : IEntityTypeConfiguration<OksLogRateLimit>
{
    public void Configure(EntityTypeBuilder<OksLogRateLimit> builder)
    {
        builder.ToTable("OksLogRateLimit");
